...
// SPEECHSAASPROD20231107 provides the API operation methods for making requests to
// SPEECH_SAAS_PROD. See this package's package overview docs
// for details on the service.
//
// SPEECHSAASPROD20231107 methods are safe to use concurrently. It is not safe to
// modify mutate any of the struct's properties though.
type SPEECHSAASPROD20231107 struct {
	*client.Client
}
...
func New(p client.ConfigProvider, cfgs ...*volcengine.Config) *SPEECHSAASPROD20231107 {
	c := p.ClientConfig(EndpointsID, cfgs...)
	return newClient(*c.Config, c.Handlers, c.Endpoint, c.SigningRegion, c.SigningName)
}

// newClient creates, initializes and returns a new service client instance.
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SPEECHSAASPROD20231107 {
	svc := &SPEECHSAASPROD20231107{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SPEECHSAASPROD20231107 operation and runs any
// custom request initialization.
func (c *SPEECHSAASPROD20231107) newRequest(op *request.Operation, params, data interface{}) *request.Request {
